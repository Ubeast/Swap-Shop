                ...
                <form class="form-signin" action="AddItem.php"  method="post">
                    ...
                    <div class="row">
                        ...
                        <input type="text" id="inputFirst" class="form-control" placeholder="Item Name" name="itemname" required autofocus
                               onblur="checkuser()" style="margin-bottom: 5px;">
                    ...
                    <div class="row">
                        <div class="col-xs-0">
                            <label for="inputLast" class="sr-only">Image Link</label>
                        </div>

                        <input type="text" id="inputLast" class="form-control" placeholder="Image Link" name="imglink" required autofocus
                               onblur="checkuser()" style="margin-bottom: 5px;">
                    ...
                    <div class="row">
                        <div class="col-xs-0">
                            <label for="inputLast" class="sr-only">Item Price</label>
                        </div>

                        <input type="text" id="inputLast" class="form-control" placeholder="Item Price" name="iprice" required autofocus
                               onblur="checkuser()" style="margin-bottom: 5px;">
                    ...
                    <div class="row">
                        <div class="col-xs-0">
                            <label for="inputLast" class="sr-only">Item Catagory</label>
                        </div>

                        <input type="text" id="inputLast" class="form-control" placeholder="Item Catagory" name="catag" required autofocus
                               onblur="checkuser()" style="margin-bottom: 5px;">
                    ...
                    <div class="row">
                        <div class="col-xs-0">
                            <label for="inputEmail" class="sr-only">Item Description</label>
                        </div>

                        <textarea type="email" id="inputEmail" class="form-control" placeholder="Item Description" name="description" required autofocus
                                  onblur="checkuser()" style="margin-bottom: 10px;"></textarea>
